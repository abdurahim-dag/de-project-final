kafkacat -b rc1a-t8qa66m62evas38u.mdb.yandexcloud.net:9091 -t message-service-input -X security.protocol=SASL_SSL -X sasl.mechanisms=SCRAM-SHA-512 -X sasl.username="consumer_producer" -X sasl.password="Ragim1984" -X ssl.ca.location=/mnt/c/Users/Ragim/PycharmProjects/de-project-final/CA.pem -C -o beginning
